...
class MapEncoder(nn.Module):
    ...
    def forward(self, data: Batch) -> torch.Tensor:
        ...
        #attention
        #c2l
        l_embs,_ = self.c2l_attn_layer(x = [c_embs, l_embs], edge_index = c2l_edge_index, edge_attr = c2l_edge_attr_embs)         #[(M1,...,Mb),D]

        #l2l
        l_embs,_ = self.l2l_attn_layer(x = l_embs, edge_index = l2l_edge_index, edge_attr = l2l_edge_attr_embs)                   #[(M1,...,Mb),D]
